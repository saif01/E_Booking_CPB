...
if(isset($_POST['submit']))
{
    ...
    $ldaphost = "10.64.1.3"; 
    $ldapuser = $user_login."@cpbd.co.bd";
    ...
    if ($ldapbind) 
    {
      ...
      $UserSql=mysqli_query($con,"SELECT * FROM `user` WHERE `user_login`='$user_login'");
      ...
      //$UserSql=mysqli_query($con,"SELECT * FROM `user` WHERE `user_login`='$user_login' AND `user_pass`='$password'");
        ...
        // ************** For All Section user **********************////
                    ...
                    {
                        $_SESSION['errmsg']="User ID Not Avaiable in CPB-IT Portal.!!!";       
