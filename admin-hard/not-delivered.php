                             ...
                             <div class="col-md-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        ...
                                        <h3 class="panel-title">All Processing Complains Reports</h3>
...
<a href="javascript:void(0);" onClick="popUpWindow('user-profile?user_id=<?php echo ($row['user_id']); ?>');" title="User Details"><?php echo ($row['user_name']); ?></a>
       ...
       <!--   Edit   -->  
         ...
         <a href="action.php?hard_id=<?php echo $row['hard_id']?>" title="Action">  <span class="btn btn-warning"><i class="fa fa-edit text-success"></i> Action</span> </a>
