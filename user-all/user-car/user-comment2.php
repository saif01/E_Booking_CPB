            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="section-title  text-center">
                       ...
                       <h2> 
                        <?php echo htmlentities($_SESSION['user_all']) ?>'s Booked car Commend Section</h2>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="user-comment-action.php?booking_id=<?php echo $booking_id; ?> &driver_id=<?php echo $driver_id ?>" method="post" name="chngpwd" >
