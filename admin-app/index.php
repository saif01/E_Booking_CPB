...
$query2="SELECT `status`, COUNT(*) AS number FROM `cms_app_complain` GROUP BY `status`";
$result2 = mysqli_query($con, $query2);
 

//  pie Chart of *****user
$query3="SELECT user.user_name, COUNT(cms_app_complain.app_id) AS number FROM `cms_app_complain` LEFT JOIN user ON cms_app_complain.user_id=user.user_id GROUP BY user.user_name ";
...
//Total Complains
$sql4=mysqli_query($con,"SELECT * FROM `cms_app_complain`");
