...
$mailSQL=mysqli_query($con,"SELECT user.user_name, user.user_mail FROM user INNER JOIN cms_app_complain ON user.user_id=cms_app_complain.user_id  WHERE cms_app_complain.app_id='$app_id'");
