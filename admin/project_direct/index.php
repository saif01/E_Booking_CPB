    ...
    <section id="nav" class="py-3 nav_coustom text-center fixed-top">
      <div class="container">
        <div class="row">
          ...
          <h2   class="text-light d-inline" style="font-family: Times New Roman"> C.P.B. IT-Portal Admin Section</h2>
          </div>
        </div>
      </div>
    </section>
        ...
        <div class="col-md-4 text-center col-sm-6">
          <div class="card" style="margin-top: 10%;">
            <div class="card-body" style="background-color: #191970; color:#912CEE;">
              <h3>Legal Admin</h3><hr>
         
          <a href="../../admin-law">
          <button class="button4"><span>Legal Admin </span> </button>
          </a>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-8 col-sm-6">
          <div id="mycarousel4" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner" role="listbox">
                  ...
                  <div class="carousel-item  active">
                      <img src="img/super/superadmin (1).jpg" height="300" width="700" class="rounded" >
