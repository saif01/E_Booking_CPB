...
$sql=mysqli_query($con,"SELECT * FROM `user` WHERE `user_login`='$user_login' AND `user_pass`='$password'");
...
if($num>0)
    {
        $con=mysqli_query($con,"UPDATE `user` SET `user_pass`='$newpassword'  WHERE `user_login`='$user_login' ");
