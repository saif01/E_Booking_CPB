    ...
    <body>
        <div class="container-scroller">
                            ...
                            <div class="col-lg-12 grid-margin stretch-card">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <button class="card-title btn btn-outline btn-block ">Car Maintenance Report</button>
            ...
            <table id="example" class="table table-striped table-bordered table-dark">
                                                ...
                                                <tbody>
                                                    <?php 
    $query=mysqli_query($con,"SELECT car_maintenance.ment_id, car_maintenance.ment_stat, car_maintenance.ment_end, car_maintenance.ment_st, car_driver.driver_name, tbl_car.car_name, tbl_car.car_namePlate  FROM `car_maintenance` INNER JOIN car_driver ON car_maintenance.driver_id=car_driver.driver_id INNER JOIN tbl_car ON car_maintenance.car_id=tbl_car.car_id ORDER BY car_maintenance.ment_id DESC");
...
?>
                                 ...
                                 <td><?php echo date("M j, Y, g:i a", strtotime($row['ment_stat'])); ?></td>
                                 <td><?php echo date("M j, Y, g:i a", strtotime($row['ment_end'])); ?></td>
...
<a href="police-req-status.php?h_ment_id=<?php echo ($row['ment_id']);?>" title="Cancel" id="hide" > <i class="mdi mdi-check-all text-success icon-lg"></i></a>
...
<script>  
         $(document).on("click", "#hide", function(e){
             ...
             var link = $(this).attr("href");
                swal({
                  title: "Are you Want to Cancel Maintenance Schedule?",
