    ...
    while($row=mysqli_fetch_array($ret))
                {   
                    ...
                    {  
                        ...
                        $log=mysqli_query($con,"INSERT INTO `loginlog`(`user_name`, `user_id`, `user_ip`, `user_os`, `user_browser`, `user_device`, `user_status`) VALUES ('".$_SESSION['admin-car-login']."','".$_SESSION['admin_id']."','$ip','$os','$browser','$device','$admin_status')");
                ...
                if ($st==1 && $st2==0) 
                    {  
                        ...
                        $_SESSION['admin-car-login']=$_POST['adminName'];
                        $_SESSION['admin_id']=$row['admin_id'];
                        $admin_status=$row['admin_status'];
                        $ip= UserInfo::get_ip();
                        $os= UserInfo::get_os();
            ...
            elseif($st==0)
                {
                    ...
                    $_SESSION['admin-car-login']=$_POST['adminName'];
                     ...
                     $log=mysqli_query($con,"INSERT INTO `loginlog`(`user_name`, `user_ip`, `user_os`, `user_browser`, `user_device`) VALUES ('".$_SESSION['admin-car-login']."','$ip','$rowcount','$browser','$device')");
