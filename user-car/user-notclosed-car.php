            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="section-title  text-center">
                       ...
                       <h2> 
                        <?php echo htmlentities($_SESSION['car_logIn_id']) ?>'s Not Closed Comment</h2>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-4">
                                                                <div class="car-list-thumb-s">
                                                                    <a href="car-details?car_id=<?php echo htmlentities($row['car_id']);?> ">  <img src="../pimages/car/<?php echo($row['car_img']);?>" class="" alt="Image" /></a>
                                                                </div>
                                                            </div>
                                                            <!-- Single Car Thumbnail -->
