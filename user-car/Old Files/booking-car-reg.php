...
$username= $_SESSION['car_logIn_id'];
...
//**************************************************************************************************************Start Not Full Day Booking Checking Logic************************************************************************************************************************************************************************************//
            ...
            $sql=mysqli_query($con,"SELECT * FROM `car_booking` WHERE `car_id`='$car_id' AND `boking_status`='1' AND `start_date` BETWEEN '$start_book' AND '$end_book' OR `end_date` BETWEEN '$start_book' AND '$end_book' OR '$start_book' BETWEEN `start_date` AND `end_date`");
             ...
             // SELECT * FROM `car_booking` WHERE `car_id`='$car_id' AND `boking_status`='1' AND `start_date` BETWEEN '$start_book' AND '$end_book' OR `end_date` BETWEEN '$start_book' AND '$end_book' OR '$start_book' BETWEEN `start_date` AND `end_date`
