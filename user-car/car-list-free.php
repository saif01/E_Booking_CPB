...
<body class="loader-active">
 ...
 <!--== Page Title Area Start ==-->
    ...
    $query=mysqli_query($con,"SELECT tbl_car.car_id, tbl_car.car_name, tbl_car.car_namePlate, tbl_car.car_capacity, tbl_car.car_img1, car_driver.driver_id, car_driver.driver_name, car_driver.driver_phone, car_driver.driver_img, car_driver.leave_start, car_driver.leave_end FROM car_booking INNER JOIN tbl_car ON car_booking.car_id=tbl_car.car_id INNER JOIN car_driver ON tbl_car.car_id=car_driver.car_id WHERE car_booking.boking_status='1' AND tbl_car.temp_car='$car_type' AND ( car_booking.start_date NOT BETWEEN '$start_book' AND '$end_book' OR car_booking.end_date NOT BETWEEN '$start_book' AND '$end_book' OR '$start_book' NOT BETWEEN car_booking.start_date AND car_booking.end_date OR '$end_book' NOT BETWEEN car_booking.start_date AND car_booking.end_date ) GROUP BY tbl_car.car_id ");
...
$driver_leave_start=$driver_lev['leave_start'];
$driver_leave_end=$driver_lev['leave_end'];
