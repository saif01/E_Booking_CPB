...
<html lang="en">
    ...
    <body>
        <div class="container-scroller">
                            ...
                            <div class="col-lg-12 grid-margin stretch-card">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <button class="card-title btn btn-outline btn-block ">Sattaled Case Reports</button>
          ...
          <?php 
        $status='Sattaled';
    $query=mysqli_query($con,"SELECT * FROM `law_report` WHERE `status`='$status'");
...
?>
                                ...
                                <td>
   <a href="law-sattaled.php?case_no=<?php echo $row['case_no'];?>" title="View Driver Info."><button type="button" class="btn btn-outline-danger">Sattaled</button> </a>
