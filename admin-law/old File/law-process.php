                            ...
                            <div class="col-lg-12 grid-margin stretch-card">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <button class="card-title btn btn-outline btn-block ">Case In Process  Action</button>
        ...
        <td><?php echo date("M j, Y", strtotime($row['filling'])); ?></td>
         <td><?php echo date("M j, Y", strtotime($row['last_hearing'])); ?></td>
                ...
                <div class="col-12 grid-margin">
                 	...
                 	<button class="card-title btn btn-outline btn-block ">Case In Process  Update</button>
