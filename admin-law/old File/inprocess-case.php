                            ...
                            <div class="col-lg-12 grid-margin stretch-card">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <button class="card-title btn btn-outline btn-block ">Inprocess Case Reports</button>
...
?>
                                ...
                                <td>
   <a href="law-process.php?case_no=<?php echo $row['case_no'];?>" title="View"><button type="button" class="btn btn-outline-danger">Processing</button> </a>
