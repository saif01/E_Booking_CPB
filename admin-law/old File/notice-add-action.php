...
$file=$_FILES['photo']['tmp_name'];
	...
	if ($file !=="") 
	{
	    ...
	    $query=mysqli_query($con,"INSERT INTO `legal_notice`(`subject`, `type`, `details`, `photo`, `show_st`) VALUES ('$subject','$type','$details','$file_name','$show_st')");
	...
	{
		 $query=mysqli_query($con,"INSERT INTO `legal_notice`(`subject`, `type`, `details`, `show_st`) VALUES ('$subject','$type','$details','$show_st')");
