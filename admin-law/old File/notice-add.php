...
<script type="text/javascript">
    ...
    <body>
                        ...
                        <div class="col-12 grid-margin">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <button class="card-title btn btn-outline btn-block ">Legal Notice Registration</button>
                <form class="form-sample" action="notice-add-action.php" method="post" enctype="multipart/form-data">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                    	<textarea type="text" name="details" class="form-control" placeholder="Enter Notice Description" required></textarea>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
                <div class="form-group row">
                    <label class="col-sm-3 col-form-label">Notice Image</label>
                     <div class="col-sm-9">
