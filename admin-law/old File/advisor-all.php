                      ...
                      <div class="col-lg-12 grid-margin stretch-card">
                          <div class="card">
                              <div class="card-body">
                                  ...
                                  <button class="card-title btn btn-outline btn-block ">All Legal Advisor Information</button>
...
?>
              ...
              <img src="../pimages/advisor/<?php echo($row['photo']);?>" class="img-responsive" alt="Image" /></td>
                          <td>
                  ...
                  <?php echo htmlentities($row['name']) ; ?>
                          ...
                          <a href="advisor-status.php?hide_id=<?php echo $row['advisor_id'];?>" title="Hide" id="hide" > <i class="mdi mdi-eye text-success icon-lg"></i></a>
                                      
                                  <?php } else {?>

      

                              <a href="advisor-status.php?show_id=<?php echo $row['advisor_id'];?>" title="Show" id="show" > <i class="mdi mdi-eye-off text-danger icon-lg"></i></a> 
                                      <?php } ?>
