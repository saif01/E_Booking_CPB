...
?>
         ...
         <a href="notice-status.php?hide_id=<?php echo $row['notice_id'];?>" title="Hide" id="hide" > <i class="fa fa-eye text-success" style="font-size: 40px;"></i></a>
                                      
                                  <?php } else {?>

      

       <a href="notice-status.php?show_id=<?php echo $row['notice_id'];?>" title="Show" id="show" > <i class="fa fa-eye-slash text-danger" style="font-size: 40px;"></i></a> 
                                      <?php } ?>


       <!--   Edit   -->  
                                 
        <a href="notice-edit?notice_id=<?php echo htmlentities($row['notice_id']);?>"
           title="Edit" > <i class="fa fa-edit text-warning" style="font-size: 40px;"></i></a>
        <!--  Delete  -->           
        <a href="notice-delete.php?deleteId=<?php echo $row['notice_id']?>"
           title="Delete" id="delete" > <i class="fa fa-trash text-danger" style="font-size: 40px;"></i></a>
              ...
              <img src="../pimages/notice/<?php echo($row['photo']);?>" class="img-responsive center-block" alt="Image" hight="50" width="80" /></td>
                          <td class="text-center" >
