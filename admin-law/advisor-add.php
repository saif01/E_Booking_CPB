...
<form class="form-horizontal" action="advisor-add-action.php" method="post" enctype="multipart/form-data">
...
<button type="submit" name="submit"  class="btn btn-block btn-rounded btn-custom  btn-lg btn-primary waves-effect waves-light">Legal Advisor Add</button>
