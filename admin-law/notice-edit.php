...
<form class="form-horizontal" action="notice-edit-action.php?notice_id=<?php echo $notice_id ; ?>" method="post" enctype="multipart/form-data">
...
?>
    ...
    <div class="col-md-6"> 
            ...
            <label class="col-sm-3 control-label">Description</label>
                <div class="col-sm-9">
                <textarea type="text" class="summernote" name="details"><?php echo($row[details]); ?></textarea>
                </div>
            </div>
    </div>
                ...
                <div class="col-sm-9">
                  ...
                  <table class="table table-bordered ">
                    ...
                    <tbody>
                        ...
                        <td>
                            <img src="../pimages/notice/<?php echo($row['photo']);?>" width="120" height="120" class="img-responsive center-block" alt="Image">
                        </td>
...
<button type="submit" name="submit"  class="btn btn-block btn-rounded btn-custom  btn-lg btn-primary waves-effect waves-light">Legal Notice Update</button>
