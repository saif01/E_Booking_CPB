                             ...
                             <div class="col-md-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h3 class="panel-title">All Sattaled Case Reports</h3>
                                    </div>
...
?>
                                ...
                                <td>
   <a href="law-sattaled.php?case_no=<?php echo $row['case_no'];?>" title="View"><button type="button" class="btn btn-outline-danger">Sattaled</button> </a>
