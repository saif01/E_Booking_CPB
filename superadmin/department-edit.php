        ...
        <div class="wrapper-page">
            <div class="panel panel-color panel-primary panel-pages">
                <div class="panel-heading text-center"> 
                   <h3 class="text-center m-t-10 text-white">Edit Department Name</h3>
...
<form method="post" action="department-edit-action.php?id=<?php echo($id) ?>" >


  <div class="form-group">
    <label>Department</label>
   <input type="text" id="check_value" onBlur="userAvailability()" name="dept_name" class="form-control" value="<?php echo ($row['dept_name']); ?>" required>
