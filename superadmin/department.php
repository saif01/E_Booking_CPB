    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">Department Add</h3>
            </div>
            <div class="panel-body">


<form class="form-horizontal" action="department-action.php" method="post">

	<div class="col-md-6"> 
            <div class="form-group">
                <label class="col-sm-3 control-label">Department</label>
                <div class="col-sm-9">
                  <input type="text" id="check_value" onBlur="userAvailability()" name="dept_name" class="form-control"  placeholder="Enter CPB Department Name" required>
...
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">C.P.B. All Department's</h3>
            </div>
            <div class="panel-body">
 ...
 <div class="col-md-12 col-sm-12 col-xs-12 table-responsive ">
       <table id="datatable" class="table table-striped table-bordered text-center">
            ...
            <tbody>
<?php 
    $query=mysqli_query($con,"SELECT * FROM `department` ORDER BY `id` DESC");
                 ...
                 if ($row['last_up'] =='') {
                    ...
                    <td>
             <a href="department-delete?Id=<?php echo ($row['id']); ?>"
           title="Delete" id="delete" > <i class="fa fa-trash text-danger" style="font-size: 40px;"></i></a>

<a href="javascript:void(0);" onClick="popUpWindow('department-edit?id=<?php echo ($row['id']);?>');" title="Edit"><i class="fa fa-edit text-warning" style="font-size: 40px;"></i> </a>
