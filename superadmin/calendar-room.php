...
?>
    ...
    <body>
        ...
        <link href='../admin-room/cal/fullcalendar.print.min.css' rel='stylesheet' media='print' />
        <script src='../admin-room/cal/lib/moment.min.js'></script>
        <script src='../admin-room/cal/lib/jquery.min.js'></script>
        <script src='../admin-room/cal/fullcalendar.min.js'></script>
        <script src='../admin-room/cal/locale-all.js'></script>
