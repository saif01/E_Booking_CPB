        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="car_section">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item">
                  <a class="nav-link" href="room-all"><i class="menu-icon mdi mdi-clipboard-check text-warning"></i> All Rooms </a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="room-add"><i class="menu-icon mdi mdi-pen text-warning"></i>Add Room</a>
                </li>
