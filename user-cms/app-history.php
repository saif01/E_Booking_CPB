            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="section-title  text-center">
                       ...
                       <h2>Your Application Complain's History</h2>
...
<td>
<a href="javascript:void(0);" onClick="popUpWindow('app-comp-details?app_id=<?php echo ($row['app_id']); ?>');" title="Complain Details" class="btn btn-info" >Details</a> 
