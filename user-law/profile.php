            ...
            <!-- About Content Start -->
                    ...
                    <div class="display-table">
                        <div class="display-table-cell">
                            <div class="about-content " >
                            	...
                            	<li> Contact Number : <?php echo $row['user_contact']; ?> </li>
                            	<li> Status : <?php 
                                $st= $row['user_st']; 
                                if ($st==1) {
                                    echo 'Active';
                ...
                <div class="col-lg-4 col-md-12">
                    <div class="about-image text-center">
                      ...
                      <img src="../pimages/user/<?php echo($row['user_img']);?>" class="img-responsive img-thumbnail rounded" alt="Image" style=" border: 4px solid #912CEE;" />
                    </div>
                </div>
                <!-- About Video End -->
            </div>
