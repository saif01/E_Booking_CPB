...
//Location
$category = '';
$query1 = "SELECT * FROM `cms_hard_category` ORDER BY `category`";
...
//Location
$location = '';
$query2 = "SELECT * FROM `bu_location` ORDER BY `location_name`";
...
// Department
$department = '';
$query3 = "SELECT * FROM `department` ORDER BY `dept_name`";
           ...
           <!-- Left Sidebar Start --> 
            ...
            <div class="content-page">
            	...
            	<form class="form-inline" role="form">
            			...
            			<div class="col-md-12">
            				<div class="col-md-3">
            					 <div class="form-group">
			                        ...
			                        <select class="form-control sel-coustom"  name="category" id="category" required="required">
            				...
            				<div class="col-md-3">
            					<div class="form-group">
			                        <label class="sr-only" >B.U. Unit</label>
			                        <select class="form-control sel-coustom" name="location" id="category" required="required">
            				...
            				<div class="col-md-3">
            					...
            					<div class="form-group">
			                        ...
			                        <select class="form-control sel-coustom" name="dept" required="required">
                    ...
                    <button type="submit" name="submit" class="btn btn-success waves-effect waves-light waves-light m-l-10"> <span>Find Information</span> <i class="fa fa-search text-danger"></i></button>
