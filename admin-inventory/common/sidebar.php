...
<div class="left side-menu">
 ...
 -->
                            <li>
                                <a href="product-add" class="waves-effect">
                           ...
                           <!--  <li>
                            ...
                            <li>
                                <a href="stock-all" class="waves-effect">
                                    <i class="md md-folder-open text-danger"></i>
                                    <span>Stock All</span>
                             ...
                             <li class="has_sub">
                                <a href="#" class="waves-effect"><i class="md md-arrow-forward text-success"></i><span>Product Given Report</span><span class="pull-right"><i class="md md-add"></i></span></a>
                                <ul class="list-unstyled">

                                    <li>
                                        <a href="product-give-repo" class="waves-effect">
                                    <i class="md md-folder-open text-danger"></i>
                                    <span>All Given Report</span>
                                    
                                         </a>
                                    </li>
                                    <li>
                                        <a href="department-by-product" class="waves-effect">
                                    <i class="md md-folder-open text-danger"></i>
                                    <span>Report By Dept.</span>
